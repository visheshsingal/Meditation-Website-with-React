      ...
      <MainLayout>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col justify-center p-4 mb-12 w-full text-center bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
            ...
            Computer Science Graduate | Skilled in React, Node.js, MongoDB, C++ | Focused on Web Technologies & System Design
            </p>
          ...
          Push your limits beyond the imaginable with our app. <br/>  Available on both desktop and mobile.
          </p>
          <div className="justify-center items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
            <a
              href="https://support.google.com/chrome/answer/9658361?hl=en&co=GENIE.Platform%3DDesktop&oco=1" target="_blank" rel="noreferrer"
